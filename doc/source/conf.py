...
def write_autodoc_index():
    ...
    SRCS = [('neutron_taas_dashboard', ROOT), ]
...
project = u'Tap-as-a-Service Dashboard'
...
man_pages = [
    ('index', u'Tap-as-a-Service Dashboard Documentation',
     'Documentation for the Tap-as-a-Service Dashboard plugin to the Openstack\
      Dashboard (Horizon)',
     [u'OpenStack'], 1)
]
